...
BEGIN
    ...
    OPEN CUR 
    FETCH NEXT FROM CUR INTO @UF_ORIGEM,@CIDADE_ORIGEM,@CIDADE_DESTINO,@UF_DESTINO
    ...
    BEGIN
        ...
        BEGIN
            ...
            VALUES (@UF_ORIGEM,@CIDADE_ORIGEM,@CIDADE_DESTINO,@UF_DESTINO)
        END
        FETCH NEXT FROM CUR INTO @UF_ORIGEM,@CIDADE_ORIGEM,@CIDADE_DESTINO,@UF_DESTINO
...
exec sp_dim_trajeto '20230321'

select * from DIM_TRAJETO