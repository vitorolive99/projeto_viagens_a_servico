...
BEGIN
    ...
    BEGIN
        ...
        ELSE
        BEGIN
            UPDATE DIM_ORGAO_SUPERIOR SET COD_ORGAO_SUPERIOR = @COD_ORGAO_SUPERIOR,NOME = @ORGAO_SUPERIOR WHERE COD_ORGAO_SUPERIOR = @COD_ORGAO_SUPERIOR
        END 
        FETCH NEXT FROM CUR INTO @COD_ORGAO_SUPERIOR, @ORGAO_SUPERIOR
    END
...
exec sp_dim_orgao_superior '20230321'
